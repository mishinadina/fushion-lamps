...
describe('Verification <Counter Day> Module', function () {
	...
	it('Module 1. Breakfast: Verify that no Products from Bundle have ZERO price', async function () {
        await CounterDay.clickBreakfast(1);
        await CounterDay.checkProductsPrice();
    });
    ...
    it('Module 1. Breakfast: Fill Bundle Info with the PAST DATE, add Bundle to the Cart and verify results', async function () {
        await CounterDay.clickBreakfast(1);
		await CounterDay.pastDate();
    });
    ...
    it('Module 1. Breakfast: Verify that value of the "Add to Cart" button was changed after adding Bundle to the Cart', async function () {
        await CounterDay.clickBreakfast(1);
		await CounterDay.checkAddtoCartBtn();
    });

	it('Module 1. BBQ: Verify that no Products from Bundle have ZERO price', async function () {
    ...
    it('Module 1. BBQ: Fill Bundle Info with the PAST DATE, add Bundle to the Cart and verify results', async function () {
        await CounterDay.clickBBQ(1);
		await CounterDay.pastDate();
    });
    ...
    it('Module 1. BBQ: Verify that value of the "Add to Cart" button was changed after adding Bundle to the Cart', async function () {
        await CounterDay.clickBBQ(1);
		await CounterDay.checkAddtoCartBtn();
    });

    it('Module 1. Lunch: Verify that no Products from Bundle have ZERO price', async function () {
        await CounterDay.clickLunch(1);
        await CounterDay.checkProductsPrice();
    });

    it('Module 1. Lunch: Click on All Products from Bundle and verify that no Error 404  appears + and no zero price', async function () {
        await CounterDay.clickLunch(1);
        await CounterDay.checkProductsPage();
    });
    ...
    it('Module 1. Lunch: Fill Bundle Info with the PAST DATE, add Bundle to the Cart and verify results', async function () {
        await CounterDay.clickLunch(1);
		await CounterDay.pastDate();
    });
    ...
    it('Module 1. Lunch: Verify that value of the "Add to Cart" button was changed after adding Bundle to the Cart', async function () {
        await CounterDay.clickLunch(1);
		await CounterDay.checkAddtoCartBtn();
    });
    ...
    it('Module 2. Breakfast: Verify that no Products from Bundle have ZERO price', async function () {
        await CounterDay.clickBreakfast(2);
        await CounterDay.checkProductsPage();
    });

    it('Module 2. Breakfast: Click on All Products from Bundle and verify that no Error 404  appears + and no zero price', async function () {
        await CounterDay.clickBreakfast(2);
        await CounterDay.checkProductsPage();
    });
    ...
    it('Module 2. Breakfast: Fill Bundle Info with the PAST DATE, add Bundle to the Cart and verify results', async function () {
        await CounterDay.clickBreakfast(2);
		await CounterDay.pastDate();
    });
    ...
    it('Module 2. Breakfast: Verify that value of the "Add to Cart" button was changed after adding Bundle to the Cart', async function () {
        await CounterDay.clickBreakfast(2);
		await CounterDay.checkAddtoCartBtn();
    });

    it('Module 2. BBQ: Verify that no Products from Bundle have ZERO price', async function () {
        await CounterDay.clickBBQ(2);
        await CounterDay.checkProductsPage();
    });

    it('Module 2. BBQ: Click on All Products from Bundle and verify that no Error 404  appears + and no zero price', async function () {
        await CounterDay.clickBBQ(2);
        await CounterDay.checkProductsPage();
    });
    ...
    it('Module 2. BBQ: Fill Bundle Info with the PAST DATE, add Bundle to the Cart and verify results', async function () {
        await CounterDay.clickBBQ(2);
		await CounterDay.pastDate();
    });
    ...
    it('Module 2. BBQ: Verify that value of the "Add to Cart" button was changed after adding Bundle to the Cart', async function () {
        await CounterDay.clickBBQ(2);
		await CounterDay.checkAddtoCartBtn();
    });

    it('Module 2. Lunch: Verify that no Products from Bundle have ZERO price', async function () {
        await CounterDay.clickLunch(2);
        await CounterDay.checkProductsPage();
    });

    it('Module 2. Lunch: Click on All Products from Bundle and verify that no Error 404  appears + and no zero price', async function () {
        await CounterDay.clickLunch(2);
        await CounterDay.checkProductsPage();
    });
    ...
    it('Module 2. Lunch: Fill Bundle Info with the PAST DATE, add Bundle to the Cart and verify results', async function () {
        await CounterDay.clickLunch(2);
		await CounterDay.pastDate();
    });
    ...
    it('Module 2. Lunch: Verify that value of the "Add to Cart" button was changed after adding Bundle to the Cart', async function () {
        await CounterDay.clickLunch(2);
		await CounterDay.checkAddtoCartBtn();
    });
    ...
    it('Module 3. Breakfast: Verify that no Products from Bundle have ZERO price', async function () {
        await CounterDay.clickBreakfast(3);
        await CounterDay.checkProductsPage();
    });

    it('Module 3. Breakfast: Click on All Products from Bundle and verify that no Error 404  appears + and no zero price', async function () {
        await CounterDay.clickBreakfast(3);
        await CounterDay.checkProductsPage();
    });
    ...
    it('Module 3. Breakfast: Fill Bundle Info with the PAST DATE, add Bundle to the Cart and verify results', async function () {
        await CounterDay.clickBreakfast(3);
		await CounterDay.pastDate();
    });
    ...
    it('Module 3. Breakfast: Verify that value of the "Add to Cart" button was changed after adding Bundle to the Cart', async function () {
        await CounterDay.clickBreakfast(3);
		await CounterDay.checkAddtoCartBtn();
    });

    it('Module 3. BBQ: Verify that no Products from Bundle have ZERO price', async function () {
        await CounterDay.clickBBQ(3);
        await CounterDay.checkProductsPage();
    });

    it('Module 3. BBQ: Click on All Products from Bundle and verify that no Error 404  appears + and no zero price', async function () {
        await CounterDay.clickBBQ(3);
        await CounterDay.checkProductsPage();
    });
    ...
    it('Module 3. BBQ: Fill Bundle Info with the PAST DATE, add Bundle to the Cart and verify results', async function () {
        await CounterDay.clickBBQ(3);
		await CounterDay.pastDate();
    });
    ...
    it('Module 3. BBQ: Verify that value of the "Add to Cart" button was changed after adding Bundle to the Cart', async function () {
        await CounterDay.clickBBQ(3);
		await CounterDay.checkAddtoCartBtn();
    });

    it('Module 3. Lunch: Verify that no Products from Bundle have ZERO price', async function () {
        await CounterDay.clickLunch(3);
        await CounterDay.checkProductsPage();
    });

    it('Module 3. Lunch: Click on All Products from Bundle and verify that no Error 404  appears + and no zero price', async function () {
        await CounterDay.clickLunch(3);
        await CounterDay.checkProductsPage();
    });
    ...
    it('Module 3. Lunch: Fill Bundle Info with the PAST DATE, add Bundle to the Cart and verify results', async function () {
        await CounterDay.clickLunch(3);
		await CounterDay.pastDate();
    });
    ...
    it('Module 3. Lunch: Verify that value of the "Add to Cart" button was changed after adding Bundle to the Cart', async function () {
        await CounterDay.clickLunch(3);
		await CounterDay.checkAddtoCartBtn();
    });
